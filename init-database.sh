...
USE Game_Store_System;
    ...
    (NULL, 'Mike Mix 1 (Giggity Mix)', NULL, NULL, 0.50, 'https://game-and-music-files.s3.eu-west-1.amazonaws.com/Music Cover Image and cloud movement script/cloud-animation.mp4', NULL, 'https://game-and-music-files.s3.eu-west-1.amazonaws.com/songs/Mike Mix 1 (Giggity Mix).wav', 'https://game-and-music-files.s3.eu-west-1.amazonaws.com/songs/Mike Mix 1 (Giggity Mix).wav', 200),
    ...
    (NULL, 'Soft Chaos', NULL, NULL, 0.50, 'https://game-and-music-files.s3.eu-west-1.amazonaws.com/Music Cover Image and cloud movement script/cloud-animation.mp4', NULL, 'https://game-and-music-files.s3.eu-west-1.amazonaws.com/songs/Soft Chaos.wav', 'https://game-and-music-files.s3.eu-west-1.amazonaws.com/songs/Soft Chaos.wav', 200),
