...
export default function Login() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-linear-to-br from-[#041529] to-[#2970c2] text-white">
      <div className="w-full max-w-md p-8 space-y-6 bg-linear-to-br bg-[#252246] rounded-lg shadow-md">
